...
class Kvh_Notification_Block_Adminhtml_Notification_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs

{
...

  {
      ...
      $this->setTitle(Mage::helper('notification')->__('Notification Information'));
